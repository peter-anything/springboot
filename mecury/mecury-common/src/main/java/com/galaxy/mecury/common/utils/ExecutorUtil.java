...
import static com.galaxy.mecury.common.constants.CommonConstants.THREAD_NAME_KEY;

public class ExecutorUtil {
    private static final Logger logger = LoggerFactory.getLogger(com.galaxy.mecury.common.utils.ExecutorUtil.class);
