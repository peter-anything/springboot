...
public class BaseElasticSearchService {
    ...
    public void createIndex(String indexName, String idxSQL) {
        try {
    ...
    public void insertOrUpdateOne(String indexName, ElasticSearchEntity entity) {
    ...
    public void deleteOne(String idxName, ElasticSearchEntity entity) {
    ...
    public void insertBatchTrueObj(String idxName, List<ElasticSearchEntity> list) {
        BulkRequest request = new BulkRequest();
        list.forEach(item -> request.add(new IndexRequest(idxName).id(item.getId())
    ...
    public <T> List<T> search(String idxName, SearchSourceBuilder builder, Class<T> clz) {
